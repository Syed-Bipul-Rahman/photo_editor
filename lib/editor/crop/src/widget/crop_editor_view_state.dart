...
import 'package:photo_management_app/editor/crop/src/widget/calculator.dart';
...
class ReadyCropEditorViewState extends CropEditorViewState {
  ...
  ReadyCropEditorViewState scaleUpdated(
    ...
    final baseSize = isFitVertically
        ? Size(viewportSize.height * imageSize.aspectRatio, viewportSize.height)
        : Size(viewportSize.width, viewportSize.width / imageSize.aspectRatio);
